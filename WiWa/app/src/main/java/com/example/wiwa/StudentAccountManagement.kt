...
import com.example.wiwa.databinding.FragmentStudentAccountManagementBinding
    ...
    private fun changePassword(){
        ...
        if(enteredCurrentPass.text.isNotEmpty()&&
            ...
            if(enteredNewPass.text.toString().equals(enteredConfirm.text.toString())){
                ...
                if(user!=null){
                    val credential = EmailAuthProvider.getCredential(user.email!!, enteredCurrentPass.text.toString())
              ...
              if(enteredNewPass.text.isEmpty()){
                  enteredCurrentPass.error = "Please enter new password."
              }
